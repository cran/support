...
sp_cpp <- function(des_num, dim_num, ini, distind, distparam, distsamp, thin, bd, point_num, it_max, it_min, tol, num_proc, n0, wts) {
    .Call(`_support_sp_cpp`, des_num, dim_num, ini, distind, distparam, distsamp, thin, bd, point_num, it_max, it_min, tol, num_proc, n0, wts)
}
